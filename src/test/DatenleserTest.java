...
public class DatenleserTest {
    ...
    public void testWriteNote() throws IOException {
        ...
        assertEquals(testAcht.getLine(),"1;0;0");
        
    }

    @Test       //Test muss allgemeiner gehalten werden, klappt durch Testpfad nur auf Max Laptop
    public void testExportKlasse() throws IOException {
        Datenleser testNeun = new Datenleser();
        testNeun.exportKlasse();
        File file = new File("C:/Users/LG/Desktop/ExportTest/CSV_Dateien/Test/Schuelerliste.csv");
        assertEquals(true, file.exists());
        file.delete();
    }
